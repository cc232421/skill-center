...
description: Intelligently compress and rewrite documents into TTS-friendly scripts. Uses Codex AI to analyze content, compress to target duration, convert to spoken style with emotional language, and auto-segment. Perfect for video narration.
...
- 🤖 **AI 智能分析**：Codex 分析文章内容，判断最佳视频时长和配图风格
...
```bash
python ~/.Codex/skills/tts-script-generator/scripts/generate.py <markdown文件>
```
- 读取 Markdown 文件
- 提取 H2 章节
- 转换为口语化
