...
If `.agents/product-marketing-context.md` exists (or `.Codex/product-marketing-context.md` in older setups), read it before editing. Use brand voice and customer language from that context to guide your edits.
