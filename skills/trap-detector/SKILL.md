...
4. **基本面与热度脱节** — 调用 `skills/institutional-analysis/scripts/fetch_financials.py` + `skills/institutional-analysis/scripts/fetch_sentiment.py` 对比
5. **K 线异常配合** — 调用 `skills/institutional-analysis/scripts/fetch_kline.py`，看是否在推荐密集期前已大幅拉升
