...
每次改 run_real_test.py / lib/* / fetchers，都跑这个文件：
    cd skills/institutional-analysis/scripts && python3 -m pytest tests/test_no_regressions.py -v

或者直接：
    cd skills/institutional-analysis/scripts && python3 tests/test_no_regressions.py
