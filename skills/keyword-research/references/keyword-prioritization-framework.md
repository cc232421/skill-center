...
## Quick Win vs Growth vs Long-tail

| Category | Characteristics | Best For |
|----------|----------------|----------|
| Quick Win | Low difficulty, any volume | New sites building authority |
| Growth | Medium difficulty, high volume | Established sites scaling traffic |
| Long-tail | Very low difficulty, low volume | Niche sites, high conversion |
